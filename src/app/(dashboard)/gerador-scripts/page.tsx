...
const SUGESTOES = [
  ...
  'Primeiro contato para prospecção de Assinatura Nex House (Atrium/Gallery)',
  'Convite para visita/tour no Nex House Casa de Pedra',
  'Reativação de lead que pediu informações e sumiu',
  'Template de confirmação de visita agendada (Utilidade)',
]
...
export default function GeradorScriptsPage() {
  ...
  async function send(texto?: string) {
    ...
    try {
      const res = await fetch('/api/gerador-scripts', {
        method: 'POST',
            ...
            <div className="h-full flex flex-col items-center justify-center gap-5">
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm text-nex-gray-400 text-center max-w-md">
                  {modo === 'gerar'
                    ? 'Descreva o objetivo da mensagem. O script sai pronto, dentro das regras de caracteres do WhatsApp (WABA), no tom do Nex e com os dados reais da base de conhecimento (produto, preço, condição).'
                    : 'Cole um texto já pronto. Eu adapto para um template WABA válido e aprovável, no tom do Nex e fiel à base de conhecimento, sinalizando o que mudou.'}
                </p>
              </div>
              {modo === 'gerar' && (
          ...
          <div className="flex items-end gap-2">
            <textarea
              ...
              placeholder={modo === 'gerar'
                ...
                : 'Cole aqui o texto pronto que você quer transformar em script WABA...'}
